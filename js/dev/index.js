...
function initSliders() {
  if (document.querySelector(".hero__slider")) {
    new Swiper(".hero__slider", {
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".navigate-hero__arrow--prev",
        nextEl: ".navigate-hero__arrow--next"
      },
      /*
      // Брейкпоінти
      breakpoints: {
  ...
  if (document.querySelector(".tabs-trend__slider")) {
    new Swiper(".tabs-trend__slider", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
...
function digitsCounter() {
  ...
  function digitsCountersAnimate(digitsCounter2) {
    ...
    const duration = parseFloat(digitsCounter2.dataset.flsDigcounterSpeed) ? parseFloat(digitsCounter2.dataset.flsDigcounterSpeed) : 2e3;
